...
class BookingController extends Controller
{
    ...
    public function CheckoutStore(Request $request)
    {
        ...
        if ($request->payment_method == 'Stripe') {
            Stripe\Stripe::setApiKey('sk_test_51O1klyGTpDrUE1v329TVPOzXVLWwmdhGd93RdQ3H3sdU348hL4Emsi3R3fzFY2RDEqtOrEsNCbUwr9opDtdhOKYn00YZ9tLm6c');
    ...
    public function UpdateBookingStatus(Request $request, $id)
    {
        ...
        $notification = array(
            'message' => 'Payment and Booking status has been  Updated Successfully And Booking Confirmation email has been Sent',
            'alert-type' => 'success'
        );
        return redirect()->back()->with($notification);
    }
    ...
    public function UpdateBooking(Request $request, $id)
    {
        ...
        if ($request->available_room < $request->number_of_rooms) {
            ...
            $notification = array(
                'message' => 'We have less rooms left!',
                'alert-type' => 'error'
            );
            return redirect()->back()->with($notification);
        }
